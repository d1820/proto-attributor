...
namespace ProtoAttributor.Commands.Menu
{
    ...
    internal sealed class DataAnnoRenumberAttrCommand
    {
        /// <summary> Command ID. </summary>
        public const int CommandId = 16;
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="DataAnnoRenumberAttrCommand" /> class. Adds our command
        ///     handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package"> Owner package, not null. </param>
        /// <param name="commandService"> Command service to add command to, not null. </param>
        private DataAnnoRenumberAttrCommand(AsyncPackage package, OleMenuCommandService commandService,
        ...
        public static DataAnnoRenumberAttrCommand Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new DataAnnoRenumberAttrCommand(package, commandService, SDTE, attributeService, textSelectionExecutor);
        }
